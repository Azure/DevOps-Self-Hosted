...
// Resource Group
module rg '../../../CARML0.4/Microsoft.Resources/resourceGroups/deploy.bicep' = if(deploymentsToPerform == 'All') {
...
module nsg '../../../CARML0.4/Microsoft.Network/networkSecurityGroups/deploy.bicep' = if(deploymentsToPerform == 'All') {
...
// Virtual Network
module vnet '../../../CARML0.4/Microsoft.Network/virtualNetworks/deploy.bicep' = if(deploymentsToPerform == 'All') {
...
module vmss '../../../CARML0.4/Microsoft.Compute/virtualMachineScaleSets/deploy.bicep' = {
